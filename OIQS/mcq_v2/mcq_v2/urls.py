...
from .views import RemoveQuiz,information,EditStudent,EditTeacher,AddtoList,DeleteQuestion,EditQuestion,AddQuestion,AddQuiz,deleteQuiz,editQuiz,index,login_view,signup,instruction,dashboard,leaderboard,logout_view,result,teacher
...
urlpatterns = [
    ...
    path('RemoveQuiz/<int:id>',RemoveQuiz,name="RemoveQuiz"),
